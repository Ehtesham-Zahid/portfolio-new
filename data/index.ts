...
export const projects = [
  ...
  {
    id: 2,
    title: "Meat Shop - Product Catalog Website",
    des: "A sleek and user-friendly product catalog website for a meat shop, featuring a clean design, responsive layout, and easy navigation.",
    img: "/p24.png",
    iconLists: ["/next.svg", "/js.svg", "/tail.svg"],
    showLink: "laylanismeat.com",
    link: "https://laylanis.vercel.app/",
  },
  {
    id: 3,
  ...
  {
    id: 4,
    title: "IylaVista - Modern Tech Landing Page",
    des: "IylaVista is a modern tech landing page that showcases the latest in technology and innovation.",
    img: "/p25.png",
    iconLists: ["/next.svg", "/ts.svg", "/tail.svg"],
    showLink: "iylavista.com",
    link: "https://iyla-vista1.vercel.app/",
  },
];
